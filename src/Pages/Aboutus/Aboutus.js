      ...
      <div className="hero-content text-center text-neutral-content">
        <div className="max-w-4xl">
          ...
          <p className="mb-5 text-xl">
            ...
            impulsive, risk-taking, irresponsible and lacking in self-esteem and
            ambitiousness. They were also significantly anxious and depressed
            compared with male norms.
          </p>
        </div>
      </div>
    </div>
